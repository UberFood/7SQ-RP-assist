...
function apply_calingalator(position, radius, flat_heal, roll_heal) {
  ...
  for (var i = 0; i < candidate_cells.length; i++) {
    ...
    if (target_character_number > 0) {
      ...
      var note = "";
      if (character_state.special_effects[target_character_number].hasOwnProperty("calingalator_target")) {} else {
        var coin = roll_x(2);
        if (coin == 2) {
