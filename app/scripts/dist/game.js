...
var character_state = { HP: [], main_action: [], bonus_action: [], move_action: [], stamina: [], initiative: [], can_evade: [], has_moved: [], KD_points: [], current_weapon: [], visibility: [], attack_bonus: [], damage_bonus: [], universal_bonus: [], bonus_KD: [], special_effects: [] };
...
_wsClient2.default.registerMessageHandler(function (data) {
  ...
  if ((data.to_name == my_name || data.to_name == 'all') && data.room_number == my_room) {
    if (data.command == 'player_info_response') {
      ...
      for (var _i6 = 1; _i6 < character_state.can_evade.length; _i6++) {
        character = character_detailed_info[_i6];
        if (character !== undefined && character !== null) {
          character_state.can_evade[_i6] = 1;
          character_state.has_moved[_i6] = 0;
          character_state.move_action[_i6] = move_action_map[character.agility];
          character_state.bonus_action[_i6] = bonus_action_map[character.agility];
          character_state.main_action[_i6] = main_action_map[character.agility];

          if (character_state.special_effects[_i6].hasOwnProperty("tired")) {
            // Убрать бонусы от усталости прошлого хода (чтобы когда будут накаладываться новые не штрафовать дважды)
            character_state.universal_bonus[_i6] = character_state.universal_bonus[_i6] - character_state.special_effects[_i6].tired.bonus;
          }

          if (character_state.stamina[_i6] < stamina_values[character.stamina] * 0.67) {
            if (character_state.stamina[_i6] < stamina_values[character.stamina] * 0.34) {
              if (character_state.stamina[_i6] <= 0) {
                // 3я стадия
                var tired_object = {};
                tired_object.bonus = -3;
                tired_object.stage = 3;
                character_state.special_effects[_i6].tired = tired_object;
                character_state.universal_bonus[_i6] = character_state.universal_bonus[_i6] - 3;
                character_state.move_action[_i6] = Math.ceil(character_state.move_action[_i6] * 0.25);
                if (character_state.main_action[_i6] == 1 && character_state.bonus_action[_i6] == 1) {
                  character_state.bonus_action[_i6] = 0;
                } else {
                  character_state.bonus_action[_i6] = 1;
                  character_state.main_action[_i6] = 1;
                }
              } else {
                // 2я стадия
                var tired_object = {};
                ...
                character_state.special_effects[_i6].tired = tired_object;
                character_state.universal_bonus[_i6] = character_state.universal_bonus[_i6] - 2;
                character_state.move_action[_i6] = Math.ceil(character_state.move_action[_i6] * 0.5);
              }
            } else {
              // 1я стадия
              var tired_object = {};
              ...
              character_state.special_effects[_i6].tired = tired_object;
              character_state.universal_bonus[_i6] = character_state.universal_bonus[_i6] - 1;
              character_state.move_action[_i6] = Math.ceil(character_state.move_action[_i6] * 0.75);
            }
          } else if (character_state.special_effects[_i6].hasOwnProperty("tired")) {
            // не устал -> убрать устлалость если была
            delete character_state.special_effects[_i6].tired;
          }

          if (character_state.special_effects[_i6].hasOwnProperty("adrenaline")) {
            if (character_state.special_effects[_i6].adrenaline.cooldown == 3) {
              var minus_actions = character_state.special_effects[_i6].adrenaline.minus_actions;
              while (minus_actions > 0) {
                if (minus_actions % 2 == 0) {
                  character_state.move_action[_i6] = character_state.move_action[_i6] - adrenaline_move_increase;
                } else {
                  character_state.main_action[_i6] = character_state.main_action[_i6] - 1;
                }
                minus_actions = minus_actions - 1;
              }
            }
            character_state.special_effects[_i6].adrenaline.cooldown = character_state.special_effects[_i6].adrenaline.cooldown - 1;
            if (character_state.special_effects[_i6].adrenaline.cooldown == 0) {
              delete character_state.special_effects[_i6].adrenaline;
              var message = "Умение Прилив Адреналина у " + character.name + " снова доступно.";
              pushToList(message);
            }
          }
          if (character_state.special_effects[_i6].hasOwnProperty("cut_limb")) {
            character_state.move_action[_i6] = -10;
            character_state.special_effects[_i6].cut_limb.cooldown = character_state.special_effects[_i6].cut_limb.cooldown - 1;
            if (character_state.special_effects[_i6].cut_limb.cooldown == 0) {
              delete character_state.special_effects[_i6].cut_limb;
              var message = "Сухожилия " + character.name + " восстановятся на следующем ходу.";
              pushToList(message);
            }
          }

          if (character_state.special_effects[_i6].hasOwnProperty("healed")) {
            if (character_state.special_effects[_i6].healed.cooldown > 0) {
              character_state.move_action[_i6] = 0;
              character_state.main_action[_i6] = 0;
              character_state.bonus_action[_i6] = 0;
              character_state.special_effects[_i6].healed.cooldown = character_state.special_effects[_i6].healed.cooldown - 1;
            } else {
              delete character_state.special_effects[_i6].healed;
            }
          }

          if (character_state.special_effects[_i6].hasOwnProperty("Markus_stacks")) {
            character_state.special_effects[_i6].Markus_stacks = character_state.special_effects[_i6].Markus_stacks - 1;
            if (character_state.special_effects[_i6].Markus_stacks == 0) {
              delete character_state.special_effects[_i6].Markus_stacks;
            }
          }

          if (character_state.special_effects[_i6].hasOwnProperty("shield_up")) {
            character_state.move_action[_i6] = Math.ceil(character_state.move_action[_i6] / 2);
            character_state.stamina[_i6] = character_state.stamina[_i6] - character_state.special_effects[_i6].shield_up.stamina_cost;
            var message = character.name + " продолжает держать щит (спасибо)";
            pushToList(message);
          }
          if (character_state.special_effects[_i6].hasOwnProperty("big_bro")) {
            if (character_state.special_effects[_i6].big_bro.cooldown == 0) {
              character_state.bonus_KD[_i6] = character_state.bonus_KD[_i6] - character_state.special_effects[_i6].big_bro.bonus_KD;
              delete character_state.special_effects[_i6].big_bro;
              var message = character.name + " теряет защиту Большого Брата";
              pushToList(message);
            } else {
              character_state.special_effects[_i6].big_bro.cooldown = character_state.special_effects[_i6].big_bro.cooldown - 1;
            }
          }
          if (character_state.special_effects[_i6].hasOwnProperty("gas_bomb_poison")) {
            var count = character_state.special_effects[_i6].gas_bomb_poison.poison_level;
            while (count > 0) {
              character_state.move_action[_i6] = character_state.move_action[_i6] - gas_bomb_move_reduction;
              if (count % 2 == 1) {
                character_state.main_action[_i6] = character_state.main_action[_i6] - 1;
              } else {
                character_state.bonus_action[_i6] = character_state.bonus_action[_i6] - 1;
              }
              count = count - 1;
            }
            var save_roll = roll_x(20) + parseInt(character.stamina);
            if (save_roll >= character_state.special_effects[_i6].gas_bomb_poison.threshold) {
              character_state.special_effects[_i6].gas_bomb_poison.poison_level = character_state.special_effects[_i6].gas_bomb_poison.poison_level - 1;
              var message = character.name + " успешно кидает спасбросок и уменьшает стадию отравления (теперь " + character_state.special_effects[_i6].gas_bomb_poison.poison_level + ")";
              pushToList(message);
            } else {
              var message = character.name + " проваливает спасбросок. Стадия отравления остается прежней (" + character_state.special_effects[_i6].gas_bomb_poison.poison_level + ")";
              pushToList(message);
            }
            if (character_state.special_effects[_i6].gas_bomb_poison.poison_level <= 0) {
              delete character_state.special_effects[_i6].gas_bomb_poison;
          ...
          if (character.special_type == 'sniper') {
            var effects_object = character_state.special_effects[_i6];
            if (effects_object.hasOwnProperty("sniper_passive")) {
              var current_attack_bonus = effects_object.sniper_passive.attack_bonus;
              var current_damage_bonus = effects_object.sniper_passive.damage_bonus;
              ...
              character_state.attack_bonus[_i6] = character_state.attack_bonus[_i6] - current_attack_bonus + new_attack_bonus;
              character_state.damage_bonus[_i6] = character_state.damage_bonus[_i6] - current_damage_bonus + new_damage_bonus;
              character_state.special_effects[_i6].sniper_passive.attack_bonus = new_attack_bonus;
              character_state.special_effects[_i6].sniper_passive.damage_bonus = new_damage_bonus;
            } else {
              var sniper_passive_object = {};
              sniper_passive_object.attack_bonus = 0;
              sniper_passive_object.damage_bonus = 0;
              character_state.special_effects[_i6].sniper_passive = sniper_passive_object;
            }
          }
        }
      }
...
for (var _i7 = 0; _i7 < CHAT_CASH; _i7++) {
  var current_element = $("<li>");
  current_element.attr('data-name', 'notifications_list_element_' + _i7);
