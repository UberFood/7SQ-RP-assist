    ...
    if (data.command == 'player_info_response') {
      ...
      for (var _i14 = 1; _i14 < character_state.can_evade.length; _i14++) {
        ...
        if (character !== undefined && character !== null) {
          ...
          if (character_state.special_effects[_i14].hasOwnProperty("acid_bomb_user")) {
            if (character_state.special_effects[_i14].acid_bomb_user.cooldown == 0) {
              delete character_state.special_effects[_i14].acid_bomb_user;
              var message = "Кислотная граната у" + character.name + " готова к использованию.";
              pushToList(message);
            } else {
              character_state.special_effects[_i14].acid_bomb_user.cooldown = character_state.special_effects[_i14].acid_bomb_user.cooldown - 1;
            }
          }
          ...
          if (character_state.special_effects[_i14].hasOwnProperty("acid_bomb_poison")) {
            if (character_state.special_effects[_i14].acid_bomb_poison.duration == 0) {
              character_state.bonus_KD[_i14] = character_state.bonus_KD[_i14] + character_state.special_effects[_i14].acid_bomb_poison.bonus_KD;
              delete character_state.special_effects[_i14].acid_bomb_poison;
              var message = "Броня " + character.name + " наконец восстановилась";
              pushToList(message);
            } else {
              character_state.special_effects[_i14].acid_bomb_poison.duration = character_state.special_effects[_i14].acid_bomb_poison.duration - 1;
            }
          }
