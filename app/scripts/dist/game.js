    ...
    if (data.command == 'player_info_response') {
      ...
      switch (data.skill_index) {
        ...
        case 13:
          ...
          for (var _i6 = 0; _i6 < data.outcome_list.length; _i6++) {
            var character_number = data.character_list[_i6];
            var character = character_detailed_info[character_number];
            if (data.outcome_list[_i6] == 0) {
              // Прошел спасбросок
        ...
        case 16:
          ...
          for (var _i7 = 0; _i7 < char_list.length; _i7++) {
            var character_number = char_list[_i7];
      ...
      for (var _i8 = 0; _i8 < game_state.terrain_effects.length; _i8++) {
        if (game_state.terrain_effects[_i8] !== null && game_state.terrain_effects[_i8] !== undefined) {
          switch (game_state.terrain_effects[_i8].type) {
            case "gas_bomb":
              apply_bomb(game_state.terrain_effects[_i8].position, game_state.terrain_effects[_i8].radius);
              if (game_state.terrain_effects[_i8].radius >= 4) {
                if (my_role == "gm") {
                  delete_object_command(game_state.terrain_effects[_i8].position);
                }
                game_state.terrain_effects[_i8] = null;
              } else {
                game_state.terrain_effects[_i8].radius = game_state.terrain_effects[_i8].radius + 1;
              }
              break;
            default:
      ...
      for (var _i9 = 1; _i9 < character_state.can_evade.length; _i9++) {
        character = character_detailed_info[_i9];
        if (character !== undefined && character !== null) {
          character_state.can_evade[_i9] = 1;
          character_state.has_moved[_i9] = 0;
          character_state.move_action[_i9] = move_action_map[character.agility];
          character_state.bonus_action[_i9] = bonus_action_map[character.agility];
          character_state.main_action[_i9] = main_action_map[character.agility];

          if (character_state.special_effects[_i9].hasOwnProperty("tired")) {
            // Убрать бонусы от усталости прошлого хода (чтобы когда будут накаладываться новые не штрафовать дважды)
            character_state.universal_bonus[_i9] = character_state.universal_bonus[_i9] - character_state.special_effects[_i9].tired.bonus;
          }

          if (character_state.stamina[_i9] < stamina_values[character.stamina] * 0.67) {
            if (character_state.stamina[_i9] < stamina_values[character.stamina] * 0.34) {
              if (character_state.stamina[_i9] <= 0) {
                // 3я стадия
                var tired_object = {};
                tired_object.bonus = -3;
                tired_object.stage = 3;
                character_state.special_effects[_i9].tired = tired_object;
                character_state.universal_bonus[_i9] = character_state.universal_bonus[_i9] - 3;
                character_state.move_action[_i9] = Math.ceil(character_state.move_action[_i9] * 0.25);
                if (character_state.main_action[_i9] == 1 && character_state.bonus_action[_i9] == 1) {
                  character_state.bonus_action[_i9] = 0;
                } else {
                  character_state.bonus_action[_i9] = 1;
                  character_state.main_action[_i9] = 1;
                }
              } else {
                // 2я стадия
                var tired_object = {};
                ...
                character_state.special_effects[_i9].tired = tired_object;
                character_state.universal_bonus[_i9] = character_state.universal_bonus[_i9] - 2;
                character_state.move_action[_i9] = Math.ceil(character_state.move_action[_i9] * 0.5);
              }
            } else {
              // 1я стадия
              var tired_object = {};
              ...
              character_state.special_effects[_i9].tired = tired_object;
              character_state.universal_bonus[_i9] = character_state.universal_bonus[_i9] - 1;
              character_state.move_action[_i9] = Math.ceil(character_state.move_action[_i9] * 0.75);
            }
          } else if (character_state.special_effects[_i9].hasOwnProperty("tired")) {
            // не устал -> убрать устлалость если была
            delete character_state.special_effects[_i9].tired;
          }

          if (character_state.special_effects[_i9].hasOwnProperty("light_sound_bomb_user")) {
            if (character_state.special_effects[_i9].light_sound_bomb_user.cooldown == 0) {
              delete character_state.special_effects[_i9].light_sound_bomb_user;
              var message = "Светошумовая граната у" + character.name + " готова к использованию.";
              pushToList(message);
            } else {
              character_state.special_effects[_i9].light_sound_bomb_user.cooldown = character_state.special_effects[_i9].light_sound_bomb_user.cooldown - 1;
            }
          }

          if (character_state.special_effects[_i9].hasOwnProperty("gas_bomb_user")) {
            if (character_state.special_effects[_i9].gas_bomb_user.cooldown == 0) {
              delete character_state.special_effects[_i9].gas_bomb_user;
              var message = "Газовая граната у" + character.name + " готова к использованию.";
              pushToList(message);
            } else {
              character_state.special_effects[_i9].gas_bomb_user.cooldown = character_state.special_effects[_i9].gas_bomb_user.cooldown - 1;
            }
          }

          if (character_state.special_effects[_i9].hasOwnProperty("force_field_user")) {
            if (character_state.special_effects[_i9].force_field_user.cooldown == 0) {
              delete character_state.special_effects[_i9].force_field_user;
              var message = "Силовое поле у " + character.name + " снова заряжено.";
              pushToList(message);
            } else {
              character_state.special_effects[_i9].force_field_user.cooldown = character_state.special_effects[_i9].force_field_user.cooldown - 1;
            }
          }

          if (character_state.special_effects[_i9].hasOwnProperty("pich_pich_user")) {
            if (character_state.special_effects[_i9].pich_pich_user.cooldown == 0) {
              delete character_state.special_effects[_i9].pich_pich_user;
              var message = "Умение Пыщ-Пыщ у " + character.name + " снова доступно.";
              pushToList(message);
            } else {
              if (character_state.special_effects[_i9].pich_pich_user.cooldown == pich_pich_cooldown) {
                character_state.bonus_action[_i9] = 0;
              }
              character_state.special_effects[_i9].pich_pich_user.cooldown = character_state.special_effects[_i9].pich_pich_user.cooldown - 1;
            }
          }

          if (character_state.special_effects[_i9].hasOwnProperty("pich_pich_target")) {
            var extra_actions = character_state.special_effects[_i9].pich_pich_target.extra_actions;
            while (extra_actions > 0) {
              if (extra_actions % 2 == 0) {
                character_state.move_action[_i9] = character_state.move_action[_i9] + adrenaline_move_increase;
              } else {
                character_state.main_action[_i9] = character_state.main_action[_i9] + 1;
              }
              extra_actions = extra_actions - 1;
            }
            delete character_state.special_effects[_i9].pich_pich_target;
          }

          if (character_state.special_effects[_i9].hasOwnProperty("adrenaline_user")) {
            character_state.special_effects[_i9].adrenaline_user.cooldown = character_state.special_effects[_i9].adrenaline_user.cooldown - 1;
            if (character_state.special_effects[_i9].adrenaline_user.cooldown == 0) {
              delete character_state.special_effects[_i9].adrenaline_user;
              var message = "Умение Прилив Адреналина у " + character.name + " снова доступно.";
              pushToList(message);
            }
          }

          if (character_state.special_effects[_i9].hasOwnProperty("adrenaline_target")) {
            var minus_actions = character_state.special_effects[_i9].adrenaline_target.minus_actions;
            ...
            delete character_state.special_effects[_i9].adrenaline_target;
          }

          if (character_state.special_effects[_i9].hasOwnProperty("shocked")) {
            if (character_state.special_effects[_i9].shocked.cooldown == 0) {
              character_state.defensive_advantage[_i9] = character_state.defensive_advantage[_i9] + 1;
              delete character_state.special_effects[_i9].shocked;
            } else {
              character_state.special_effects[_i9].shocked.cooldown = character_state.special_effects[_i9].shocked.cooldown - 1;
            }
          }

          if (character_state.special_effects[_i9].hasOwnProperty("cut_limb")) {
            character_state.move_action[_i9] = -10;
            character_state.special_effects[_i9].cut_limb.cooldown = character_state.special_effects[_i9].cut_limb.cooldown - 1;
            if (character_state.special_effects[_i9].cut_limb.cooldown == 0) {
              delete character_state.special_effects[_i9].cut_limb;
              var message = "Сухожилия " + character.name + " восстановятся на следующем ходу.";
              pushToList(message);
            }
          }

          if (character_state.special_effects[_i9].hasOwnProperty("healed")) {
            if (character_state.special_effects[_i9].healed.cooldown > 0) {
              character_state.move_action[_i9] = 0;
              character_state.main_action[_i9] = 0;
              character_state.bonus_action[_i9] = 0;
              character_state.special_effects[_i9].healed.cooldown = character_state.special_effects[_i9].healed.cooldown - 1;
            } else {
              delete character_state.special_effects[_i9].healed;
            }
          }

          if (character_state.special_effects[_i9].hasOwnProperty("blind")) {
            if (character_state.special_effects[_i9].blind.cooldown > 0) {
              character_state.special_effects[_i9].blind.cooldown = character_state.special_effects[_i9].blind.cooldown - 1;
            } else {
              delete character_state.special_effects[_i9].blind;
              character_state.ranged_advantage[_i9] = character_state.ranged_advantage[_i9] + 2;
              character_state.melee_advantage[_i9] = character_state.melee_advantage[_i9] + 1;
              var message = "Зрение " + character.name + " восстановилось";
              pushToList(message);
            }
          }

          if (character_state.special_effects[_i9].hasOwnProperty("Markus_stacks")) {
            character_state.special_effects[_i9].Markus_stacks = character_state.special_effects[_i9].Markus_stacks - 1;
            if (character_state.special_effects[_i9].Markus_stacks == 0) {
              delete character_state.special_effects[_i9].Markus_stacks;
            }
          }

          if (character_state.special_effects[_i9].hasOwnProperty("shield_up")) {
            character_state.move_action[_i9] = Math.ceil(character_state.move_action[_i9] / 2);
            character_state.stamina[_i9] = character_state.stamina[_i9] - character_state.special_effects[_i9].shield_up.stamina_cost;
            var message = character.name + " продолжает держать щит (спасибо)";
            pushToList(message);
          }
          if (character_state.special_effects[_i9].hasOwnProperty("big_bro")) {
            if (character_state.special_effects[_i9].big_bro.cooldown == 0) {
              character_state.bonus_KD[_i9] = character_state.bonus_KD[_i9] - character_state.special_effects[_i9].big_bro.bonus_KD;
              delete character_state.special_effects[_i9].big_bro;
              var message = character.name + " теряет защиту Большого Брата";
              pushToList(message);
            } else {
              character_state.special_effects[_i9].big_bro.cooldown = character_state.special_effects[_i9].big_bro.cooldown - 1;
            }
          }
          if (character_state.special_effects[_i9].hasOwnProperty("gas_bomb_poison")) {
            var count = character_state.special_effects[_i9].gas_bomb_poison.poison_level;
            while (count > 0) {
              character_state.move_action[_i9] = character_state.move_action[_i9] - gas_bomb_move_reduction;
              if (count % 2 == 1) {
                character_state.main_action[_i9] = character_state.main_action[_i9] - 1;
              } else {
                character_state.bonus_action[_i9] = character_state.bonus_action[_i9] - 1;
              }
              count = count - 1;
            }
            var save_roll = data.save_roll_list[_i9];
            if (save_roll >= character_state.special_effects[_i9].gas_bomb_poison.threshold) {
              character_state.special_effects[_i9].gas_bomb_poison.poison_level = character_state.special_effects[_i9].gas_bomb_poison.poison_level - 1;
              var message = character.name + " успешно кидает спасбросок и уменьшает стадию отравления (теперь " + character_state.special_effects[_i9].gas_bomb_poison.poison_level + ")";
              pushToList(message);
            } else {
              var message = character.name + " проваливает спасбросок. Стадия отравления остается прежней (" + character_state.special_effects[_i9].gas_bomb_poison.poison_level + ")";
              pushToList(message);
            }
            if (character_state.special_effects[_i9].gas_bomb_poison.poison_level <= 0) {
              delete character_state.special_effects[_i9].gas_bomb_poison;
              var message = character.name + " больше не отравлен!";
              pushToList(message);
            }
          }

          if (character_state.special_effects[_i9].hasOwnProperty("meleed")) {
            if (character_state.special_effects[_i9].meleed.cooldown <= 0) {
              delete character_state.special_effects[_i9].meleed;
              character_state.ranged_advantage[_i9] = character_state.ranged_advantage[_i9] + 1;
            } else {
              character_state.special_effects[_i9].meleed.cooldown = character_state.special_effects[_i9].meleed.cooldown - 1;
            }
          }

          if (character.special_type == 'sniper') {
            var effects_object = character_state.special_effects[_i9];
            if (effects_object.hasOwnProperty("sniper_passive")) {
              var current_attack_bonus = effects_object.sniper_passive.attack_bonus;
              var current_damage_bonus = effects_object.sniper_passive.damage_bonus;
              ...
              character_state.attack_bonus[_i9] = character_state.attack_bonus[_i9] - current_attack_bonus + new_attack_bonus;
              character_state.damage_bonus[_i9] = character_state.damage_bonus[_i9] - current_damage_bonus + new_damage_bonus;
              character_state.special_effects[_i9].sniper_passive.attack_bonus = new_attack_bonus;
              character_state.special_effects[_i9].sniper_passive.damage_bonus = new_damage_bonus;
            } else {
              var sniper_passive_object = {};
              sniper_passive_object.attack_bonus = 0;
              sniper_passive_object.damage_bonus = 0;
              character_state.special_effects[_i9].sniper_passive = sniper_passive_object;
            }
          }
        }
      }
...
for (var _i10 = 0; _i10 < CHAT_CASH; _i10++) {
  var current_element = $("<li>");
  current_element.attr('data-name', 'notifications_list_element_' + _i10);
